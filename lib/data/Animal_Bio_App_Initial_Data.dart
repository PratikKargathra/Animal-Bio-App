...
List<AnimalsType> animalTypesList = <AnimalsType>[
  ...
  AnimalsType(
    tableName: "Birds",
    bgImage: "https://www.allaboutbirds.org/news/wp-content/uploads/2022/03/LB-TOC-banner-Spring-2022-nowords.jpg",
  ),
  AnimalsType(
    tableName: "Fish",
  ...
  AnimalsType(
    tableName: "Reptiles",
    bgImage: "https://www.thesprucepets.com/thmb/XSNyjhpzf4N9OVdhiFPYjiHa2CA=/4256x2394/smart/filters:no_upscale()/close-up-of-snake-on-tree-1004923464-5c29a95946e0fb00012e7bdd.jpg",
  ),
  AnimalsType(
    tableName: "Amphibians",
    bgImage: "https://www.burkemuseum.org/sites/default/files/images/biology/herpetology/washington/pacific-tree-frog-1100x555.jpg",
  ),
  AnimalsType(
...
List<Animal> animals = <Animal>[
  ...
  Animal(
    ...
    image: "https://i.pinimg.com/736x/13/a1/a9/13a1a9646837e34df8e033afd8b75758.jpg",
    type: "Mammals",
  ),
  Animal(
    name: "Panda",
    description: "The giant panda, also known as the panda bear  is a bear species endemic to China.",
    image: "https://media-cldnry.s-nbcnews.com/image/upload/newscms/2021_27/3489810/210709-pandas-mc-10262.JPG",
    type: "Mammals",
  ),
  Animal(
    name: "Raccoon",
  ...
  Animal(
    ...
    image: "https://bsmedia.business-standard.com/_media/bs/img/article/2018-01/25/full/1516846187-1195.jpg?im=Resize,width=480",
    type: "Mammals",
  ),
  Animal(
    name: "Angelfish",
    ...
    image: "https://www.itsafishthing.com/wp-content/uploads/2021/06/rsz_shutterstock_1698803005-2.jpg",
    type: "Fish",
  ),
  Animal(
    name: "Shark",
  ...
  Animal(
    ...
    image: "https://d.newsweek.com/en/full/2007912/ducks.jpg?w=790&f=21714db5ad0dd879b25dc3d87dcb2282",
    type: "Birds",
  ),
  Animal(
    name: "Blackbirds",
    ...
    image: "https://www.woodlandtrust.org.uk/media/1319/blackbird-male-wtml-1084426-nature-photographers-ltd.jpg",
    type: "Birds",
  ),
  Animal(
    name: "Parrots",
    ...
    image: "https://vetmed.tamu.edu/news/wp-content/uploads/sites/9/2018/10/pettalk071218_400x500.jpg",
    type: "Birds",
  ),
  Animal(
    name: "Sparrows",
    ...
    image: "https://2.img-dpreview.com/files/p/TS560x560~forums/65781466/103d21caa03c4b3aac3a34deaf502df5",
    type: "Birds",
  ),
  Animal(
    name: "Frog",
  ...
  Animal(
    ...
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXUIsdgo2hCRW24mKE3iAlT5w72q013faybDJWq0vMV5bnVGax1MQmmK_hcXwPpnt7sZk&usqp=CAU",
    type: "Amphibians",
  ),
  Animal(
    name: "Caecilian",
    description: "Caecilians are a group of limbless, vermiform or serpentine amphibians.",
    image: "https://upload.wikimedia.org/wikipedia/commons/8/8c/Caecilian.jpg?20060615215444",
    type: "Amphibians",
  ),
  Animal(
    name: "Bee",
    description: "Bees are winged insects closely related to wasps and ants, known for their role in pollination.",
    image: "https://images.newscientist.com/wp-content/uploads/2017/07/25204611/p8401619.jpg?crop=16:9,smart&width=1200&height=675&upscale=true",
    type: "Invertebrates",
  ),
  Animal(
    name: "Ant",
    description: "Ants are eusocial insects of the family Formicidae and, along with the related wasps and bees.",
    image: "https://frontline.thehindu.com/environment/wild-life/cvwrko/article38430910.ece/alternates/FREE_435/FL11pfWeaver-AntOecophylla-smaragdinaPhoto-by-R-Bhanumathi1",
    type: "Invertebrates",
  ),
  Animal(
    name: "Butterfly",
    description: "Butterflies are insects in the macrolepidopteran clade Rhopalocera from the order Lepidoptera.",
    image: "https://cff2.earth.com/uploads/2021/11/09170312/shutterstock_1920502829-scaled.jpg",
    type: "Invertebrates",
  ),
  Animal(
    name: "Snakes",
    description: "Snakes are elongated, limbless, carnivorous reptiles of the suborder Serpentes.",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeeOuGce0aTSbD0xnrv3nwx5p_1Vlconlrdw&usqp=CAU",
    type: "Reptiles",
  ),
  Animal(
    name: "Turtles",
